import herobg from '../assets/blackhero.png'
    ...
    <div className="flex flex-col justify-center items-center min-h-[calc(100vh-64px)]">
      ...
      <section id="home"
        ...
        style={{ 
          ...
          <h1  className='text-3xl font-bold text-red-700' style={{ textAlign: 'left', fontSize: '8rem', marginLeft: '40px' }}>
            BarCraft
          </h1>
        ...
        <section id="aboutus" className="section">
          ...
          <div style={{ background: '#FF8C8C', height: '30px', width: '100%' , marginBottom: '4rem', marginTop: '3rem'}}></div>

        </section>


        <section id="popular" className="section" style={{background: '#FF8C8C', height: '100vh'}}>
        ...
        <section id="subs" className="section" style={{background: '#FF8C8C', height: '100vh'}}>
